...
def make_window(theme):
    ...
    input_layout =  [[sg.Menu(menu_def, key='-MENU-')],
                ...
                [sg.Slider(orientation='h', key='-SKIDER-'),
                 sg.Image(data=sg.DEFAULT_BASE64_LOADING_GIF, key='-GIF-IMAGE-'),],
                [sg.Checkbox('Checkbox', default=True, key='-CB-')],
                [sg.Radio('Radio1', "RadioDemo", default=True, size=(10,1), key='-R1-'), sg.Radio('Radio2', "RadioDemo", default=True, size=(10,1), key='-R2-')],
                [sg.Combo(values=('Combo 1', 'Combo 2', 'Combo 3'), default_value='Combo 1', readonly=True, key='-COMBO-'),
                 sg.OptionMenu(values=('Option 1', 'Option 2', 'Option 3'),  key='-OPTION MENU-'),],
                [sg.Spin([i for i in range(1,11)], initial_value=10, key='-SPIN-'), sg.Text('Spin')],
                [sg.Multiline('Demo of a Multi-Line Text Element!\nLine 2\nLine 3\nLine 4\nLine 5\nLine 6\nLine 7\nYou get the point.', size=(45,5), key='-MLINE-')],
    ...
    asthetic_layout = [[sg.T('Anything that you would use for asthetics is in this tab!')],
               [sg.Image(data=sg.DEFAULT_BASE64_ICON,  key='-IMAGE-')],
    ...
    layout = [[sg.Text('Demo Of (Almost) All Elements', size=(38, 1), justification='center', font=("Helvetica", 16), relief=sg.RELIEF_RIDGE, key='-TEXT HEADING-')]]
    ...
    if getattr(sg, 'port', None) == 'PySimpleGUI':
